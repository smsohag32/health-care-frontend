   ...
   return (
      <div className="bg-gray-100 min-h-screen py-8">
         ...
         <div className="main-container">
            ...
            {/* Hotline Number */}
            <div className="bg-red-100 p-4 rounded-lg shadow-md text-center mb-8">
               <h2 className="text-2xl font-semibold text-red-700">Emergency Hotline</h2>
